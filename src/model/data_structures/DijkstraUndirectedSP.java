...
public class DijkstraUndirectedSP {
     ...
     * @param  weightType type of the weight. 1 for compare by weight1 or 2 for compare by weight2
     * @throws IllegalArgumentException if an edge weight is negative
     * @throws IllegalArgumentException unless {@code 0 <= s < V}
     */
    public DijkstraUndirectedSP(EdgeWeightedGraph G, int s, int weightType) {
        for (Edge e : G.edges()) {
    		if (e.weight1() < 0 || e.weight2() < 0)
...
//        assert check(G, s);
     ...
     * @param  G the edge-weighted digraph
     * @param  s the source vertex
     * @param  f the destiny vertex
     * @param  weightType type of the weight. 1 for compare by weight1 or 2 for compare by weight2
     * @throws IllegalArgumentException if an edge weight is negative
     * @throws IllegalArgumentException unless {@code 0 <= s < V}
     */
    public DijkstraUndirectedSP(EdgeWeightedGraph G, int s, int f, int weightType) {
        for (Edge e : G.edges()) {
    		if (e.weight1() < 0 || e.weight2() < 0)
    			throw new IllegalArgumentException("edge " + e + " has negative weight");
        }
